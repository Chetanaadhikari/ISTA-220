...
namespace ComplexNumbers
{
    class Program
    {
        static void doWork()
        {
            ...
            temp = first / second;
                Console.WriteLine($"Devide: result is {temp}");

            if (temp == first)
            { Console.WriteLine("Comparison: temp == first"); }
            else { Console.WriteLine("Comparison: temp != first"); }
            if (temp == temp)
            { Console.WriteLine("Comparison: temp ==temp"); }

            else { Console.WriteLine("Comparison: temp != temp"); }
            ...
            Console.WriteLine($"Int value after conversion: temp == {tempInt}");
        }
