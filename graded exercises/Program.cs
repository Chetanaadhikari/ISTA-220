...
namespace EncryptionGradedEx2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //creating a dictionary with the Alphabet as key as the number as a value
            ...
            //I am creating a list where the user input key is turned into numrical value
            // with respect to my dictionary above
            ...
            //I am making sure that the key word is repeated enough times to
            //cover the entire sentence that needs to be encrypted. I have used
            //division method sentence/key and remainder method for this.
